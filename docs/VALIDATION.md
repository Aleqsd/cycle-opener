...
- Compilation Release : zéro erreur, zéro avertissement. DLL version 0.2.0.0.
- 24 690 assertions métier : niveaux 1–100 et 1–8 cibles pour les deux jobs, disponibilité des sorts, paliers, seuils WHM à 45/72, séquences d’ouverture, noms anglais et annotations, repli français, liens des sources et politique de popup. Ce chiffre compte les invariants parcourus, pas des scénarios manuels indépendants.
...
- 201 rendus natifs ImGui issus des composants du plugin : cinq niveaux, trois profils de cibles et cinq vues pour chacun des deux jobs ; fenêtre complète, largeur minimale, noms anglais/français, réglages et popup à 100/150/200 %. Aucun défilement horizontal détecté dans cette matrice.
